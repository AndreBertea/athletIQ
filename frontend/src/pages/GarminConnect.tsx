    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="mt-2 text-gray-600">
          Synchronisez vos donnees physiologiques Garmin (HRV, sommeil, readiness)
        </p>
      </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-sm text-gray-500">
              {isConnected
                ? `${garminStatus?.display_name || 'Compte connecte'} — Derniere sync : ${garminStatus?.last_sync_at ? new Date(garminStatus.last_sync_at).toLocaleDateString('fr-FR') : 'jamais'}`
          ...
          <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-4">
            <div className="flex items-start">
              ...
              <p className="text-sm text-blue-800">
                <strong>Vos identifiants ne sont pas stockes.</strong> Ils sont utilises une seule fois pour generer un token d'acces securise (chiffre). Votre email et mot de passe ne transitent que lors de cette connexion.
              </p>
            </div>
          </div>
        ...
        <>
          ...
          <div className="card">
            ...
            <div className="space-y-3">
              <div>
                <label htmlFor="days-back" className="block text-sm font-medium text-gray-600 mb-1">
          ...
          <div className="card">
            ...
            {dailyLoading ? (
                  ...
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-center py-2 px-2 text-gray-500 font-medium">
                        <div className="flex items-center justify-center" title="HRV (RMSSD)">
                          <Heart className="h-3.5 w-3.5 mr-1 text-red-400" />
                          HRV
                        </div>
                      </th>
                      <th className="text-center py-2 px-2 text-gray-500 font-medium">
                        <div className="flex items-center justify-center" title="Training Readiness">
                          <Activity className="h-3.5 w-3.5 mr-1 text-green-500" />
                          Readiness
                        </div>
                      </th>
                      <th className="text-center py-2 px-2 text-gray-500 font-medium">
                        <div className="flex items-center justify-center" title="Sleep Score">
                    ...
                    {dailyData.map((day) => (
                      <tr key={day.date} className="border-b border-gray-100 last:border-0">
                        ...
                        <td className="text-center py-2 px-2">
                          {day.hrv_rmssd != null ? (
                            <span className="font-medium text-gray-900">{Math.round(day.hrv_rmssd)}</span>
                          ) : (
                        ...
                        <td className="text-center py-2 px-2">
                          {day.training_readiness != null ? (
                            <span className={`font-medium ${
                              day.training_readiness >= 70 ? 'text-green-600' :
                              day.training_readiness >= 40 ? 'text-yellow-600' : 'text-red-600'
                            }`}>
                        ...
                        <td className="text-center py-2 px-2">
                          {day.sleep_score != null ? (
                            <span className={`font-medium ${
                              day.sleep_score >= 70 ? 'text-indigo-600' :
                              day.sleep_score >= 40 ? 'text-yellow-600' : 'text-red-600'
                            }`}>
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">Aucune donnee disponible. Lancez une synchronisation.</p>
              </div>
            )}
          </div>
          ...
          <div className="card">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-medium text-gray-900">Deconnecter Garmin</h3>
                <p className="text-sm text-gray-500 mt-1">
                  Supprime le token d'acces. Vos donnees deja synchronisees sont conservees.
                </p>
              </div>
              <button
      ...
      <div className="card">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <div className="flex items-start">
            ...
            <p>
              <strong>Securite :</strong> Votre email et mot de passe Garmin ne sont jamais stockes. Seul un token d'acces chiffre (AES-256) est conserve.
            </p>
          </div>
          <div className="flex items-start">
            <RefreshCw className="h-4 w-4 text-blue-500 mt-0.5 mr-3 flex-shrink-0" />
            <p>
              <strong>Donnees synchronisees :</strong> HRV, Training Readiness, sommeil, stress, frequence cardiaque au repos, SpO2, Body Battery.
            </p>
          </div>
          <div className="flex items-start">
            <div className="w-2 h-2 bg-primary-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
            <p>
              <strong>Frequence :</strong> Synchronisez apres chaque nuit pour avoir les dernieres donnees de recuperation.
            </p>
          </div>
        </div>
      </div>
