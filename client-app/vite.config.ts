...
export default defineConfig({
  ...
  build: {
    // Source maps en prod : sans elles, une stack comme
    // "index-XXXX.js:1014:26612" est indécodable. Avec, l'erreur pointe
    // directement vers le fichier/ligne source dans la console.
    sourcemap: true,
  },
  resolve: {
    alias: {
