...
class TestStravaOAuth:
    ...
    def test_strava_login_is_suspended(self, client, test_user_data):
        """La nouvelle connexion Strava est suspendue par defaut."""
        ...
        assert "suspendue" in response.json()["detail"]
